...
function [New_Items_Parameter_Estimate_MEM,round]=M_MEM_BME_Online_Calibration(New_Items_Parameter_Estimate_OEM,G_OEM,New_Items_Table,ID_of_Items_Answered,ID_of_New_Items_Answered,V_Matrix,New_Items_V_Matrix,A_Parameter,b_Parameter,Theta_Draw,Prior_Probability,Accuracy_of_Iteration,Mu_Beta,Sigma_Beta)
...
while (flag1==1)
    ...
    for j=1:Number_of_New_Items                 % visit each new item
        ...
        while (flag2==1)
            ...
            f=f-(Sigma_Beta)\((Parameter_Hat_MEM(j,:))'-Mu_Beta);
