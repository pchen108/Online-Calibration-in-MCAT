...
function [New_Items_Parameter_Estimate,G_OEM]=M_OEM_BME_Online_Calibration(New_Items_Table,ID_of_Items_Answered,V_Matrix,A_Parameter,b_Parameter,Parameter_Initial,Theta_Draw,Prior_Probability,Accuracy_of_Iteration,Mu_Beta,Sigma_Beta)
...
Test_Length=length(ID_of_Items_Answered(1,:));
...
for j=1:Number_of_New_Items
    ...
    while (flag==1)
        ...
        f=f-(Sigma_Beta)\(Parameter_Estimate-Mu_Beta);
